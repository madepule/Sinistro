...
public class Utilizador implements Serializable {
    ...
    public void saveProviderSP(Context context, String token ){
        ConnectFirebase.saveSP( context, PROVIDER, token );
    }
    public String getProviderSP(Context context ){
        return( ConnectFirebase.getSP( context, PROVIDER) );
    }



    public void saveDB( DatabaseReference.CompletionListener... completionListener ){
        DatabaseReference firebase = ConnectFirebase.getDatabaseReference().child("utilizadores").child( getId() );
